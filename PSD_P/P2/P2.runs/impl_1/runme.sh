...
HD_PWD='/home/miguel/P2/P2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_circuit.tcl -notrace
