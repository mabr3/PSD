...
HD_PWD='/home/miguel/P2/P2.runs/memStep_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memStep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memStep.tcl
