...
#
# Generated by export_simulation on Wed Oct 25 17:33:37 WEST 2017
#
################################################################################
...
switch to the './memRes.sh' script.
...
./memRes.sh -noclean_files

For more information on the script, please type './memRes.sh -help'.
